...
```{r fig.width=10, fig.height=0.75}
ggplot(nps_data)+
  geom_bar(mapping = aes(x="", fill = factor(nps_category, levels = c("Promoter", "Passive","Detractor"))), position = "fill")+
